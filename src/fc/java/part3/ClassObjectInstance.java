...
public class ClassObjectInstance {
    public static void main(String[] args) {
        ...
        st2=new Student("김길동", "컴퓨터공학과", 37, "bit@empas.com",2023110,"010-1111-1111"); // st2 : instance
        st3=new Student("나길동", "컴퓨터공학과", 37, "bit@empas.com",2023110,"010-1111-1111"); // st3 : instance
